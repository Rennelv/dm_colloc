...
TEST(test_MUL_Pxk_P, NormalPolynomial) {
    ...
    Polynomial res = MUL_Pxk_P(a, static_cast<size_t>(4)); 
    Polynomial expect({num1, num2, num3, num4, zero, zero, zero, zero});
    EXPECT_EQ(res, expect);  // ((8/3)x^3 + 3x^2 + 6x^1 + 4x^0) * x^4 = (8/3)x^7 + 3x^6 + 6x^5 + 4x^4
}
/*
